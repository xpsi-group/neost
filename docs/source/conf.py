# -*- coding: utf-8 -*-
#
# NEOST documentation build configuration file, created by
...
project = 'NEoST'
copyright = '2020-2023 the NEoST Core Team'
...
html_logo = "./_static/neostlogo_small.png"
...
latex_documents = [
    (master_doc, 'neost.tex', 'NEoST Documentation',
     'The NEoST Core Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'neost', 'NEoST Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NEoST', 'NEoST Documentation',
     author, 'NEoST', 'One line description of project.',
     'Miscellaneous'),
]
