...
from neost.Likelihood import Likelihood    ########### CAUTION: modified to M_TOV >= 2 M_sun (off), mock gaussian distribution on ceft band prior only ON
...
if pp and cs:
    ...
    raise ValueError('Choose either PP or CS!')
if 'n2lo' != order_lower and 'n3lo' != order_lower and 'hebeler' != order_lower and 'nlo' != order_lower and 'lo' != order_lower and 'n3lo-mod' != order_lower:
