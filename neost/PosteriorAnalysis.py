...
def compute_prior_auxiliary_data(path, EOS, variable_params, static_params, sampler='ultranest', identifier='', dm=False):
    # TODO Update description to match new parameters
    # TODO Change default sampler
    """
    ...
    if dm == True:
        ...
        fnames += ['pressures_baryon', 'pressures_dm']
